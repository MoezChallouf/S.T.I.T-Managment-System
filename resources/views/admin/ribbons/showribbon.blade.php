...
@section('title', 'Ribbon Details - STIT Management')
    ...
    <div class="team-single d-flex">
        ...
        <div class="col-lg-4 col-md-5 xs-margin-30px-bottom">
            <div class="team-single-img">
                <img src="{{asset('dist/img/ribbon.jpg')}}" alt="logo" style="width: 480px; height:320px; padding-right:120px;" >
            </div>
        </div>
        
            <div class="col-lg-8 col-md-7 ">
                <div class="team-single-text padding-50px-left sm-no-padding-left ">
                    <h1 class="font-size38 sm-font-size32 xs-font-size30" style="margin-bottom:30px;">Référance Ribbon: {{$ribbon->references}}</h1>
                        ...
                        <ul class="list-style9 ">
                            ...
                            <li>
                                <div class="row ">
                                    <div class="col-md-5 col-5">
                                        ...
                                        <strong class="margin-10px-left text-yellow">Type Ribbon:</strong>
                                    </div>
                                    <div class="col-md-7 col-7">
                                        <p>{{$ribbon->type}}</p>
                                    </div>
                            ...
                            <li>
                                <div class="row ul">
                                    ...
                                    <div class="col-md-7 col-7">
                                        <p style="color: {{ $ribbon->status === 'Epuisé' ? 'red' : 'green' }};" class="font-weight-bold ">{{$ribbon->status}} </p>
                                    </div>
                                </div>
                            </li>
                        </ul>
