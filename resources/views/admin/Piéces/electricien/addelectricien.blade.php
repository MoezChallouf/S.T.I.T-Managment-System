...
@section('title', 'Add Electricien - STIT Management')
...
<div class="col-6" style="margin: auto; padding: 40px;">
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title text-white font-weight-bold">Add New Electricien</h3>
        </div>
        <form method="POST" action="{{ route('storeelectricien') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
