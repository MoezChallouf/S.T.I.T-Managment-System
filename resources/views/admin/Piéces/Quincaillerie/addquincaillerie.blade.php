...
@section('title', 'Add Quincaillerie - STIT Management')
...
<div class="col-6" style="margin: auto; padding: 40px;">
    ...
    <div class="card card-warning">
        <div class="card-header">
            <h3 class="card-title text-white font-weight-bold">Add New Quincaillerie</h3>
        </div>
        <form method="POST" action="{{ route('storequincaillerie') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
