...
@section('title', 'tourneur Details - STIT Management')
        ...
        <div class="row border">
            <div class="col-lg-4 col-md-5 xs-margin-30px-bottom">
                <div class="team-single-img">
                    <img src="{{asset('dist/img/tourneur1.jpg')}}" alt="logo" style="width: 480px; height:480px; padding-right:50px; padding-top:30px" >
                </div>
            </div>

            <div class="col-lg-8 col-md-7 ">
                <div class="team-single-text padding-50px-left sm-no-padding-left ">
                    <h1 class="font-size38 sm-font-size32 xs-font-size30" style="margin-bottom:30px;">Turner ID : {{$tourneur->id}}</h1>
                            ...
                            <li>
                                <div class="row " >
                                    <div class="col-md-5 col-5">
                                        ...
                                        <strong class="margin-10px-left text-orange">Nom Tourneur</strong>
                                    </div>
                            ...
                            <li>
                                <div class="row ">
                                    <div class="col-md-5 col-5">
                                        ...
                                        <strong class="margin-10px-left text-red">Machine:</strong>
                                    </div>
                                    <div class="col-md-7 col-7">
                                        <p>{{$tourneur->machine}}</p>
                                    </div>
                                </div>
                            </li>
                            <li>
