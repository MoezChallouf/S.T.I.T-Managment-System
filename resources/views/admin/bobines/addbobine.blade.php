...
@section('title', 'Add Bobine - STIT Management')
...
<div class="col-6" style="margin: auto; padding: 40px;">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title text-white font-weight-bold">Add New bobine</h3>
        </div>
        <form method="POST" action="{{ route('storebobine') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                {{-- Usine --}}
