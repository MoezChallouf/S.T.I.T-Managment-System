...
@section('title', 'Bobine Details - STIT Management')
        ...
        <div class="row  >
            ...
            <div class="col-lg-8 col-md-7 ">
                <div class="team-single-text padding-50px-left sm-no-padding-left ">
                    <h1 class="font-size38 sm-font-size32 xs-font-size30" style="margin-bottom:30px;">Référance Bobine: {{$bobine->references}}</h1>
                        ...
                        <ul class="list-style9 ">
                            ...
                            <li>
                                <div class="row ">
                                    <div class="col-md-5 col-5">
                                        ...
                                        <strong class="margin-10px-left text-yellow">Type Bobine:</strong>
                                    </div>
                                    <div class="col-md-7 col-7">
                                        <p>{{$bobine->type}}</p>
                                    </div>
                            ...
                            <li>
                                <div class="row ul">
                                    ...
                                    <div class="col-md-7 col-7">
                                        <p style="color: {{ $bobine->status === 'Epuisé' ? 'red' : 'green' }};" class="font-weight-bold ">{{$bobine->status}} </p>
                                    </div>
                                </div>
                            </li>
                        </ul>
