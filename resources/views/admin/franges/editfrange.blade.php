...
@section('title', 'Edit frange - STIT Management')
...
<div class="col-6" style="margin: auto; padding: 40px;">
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title text-white font-weight-bold">Edit frange</h3>
        </div>
        <form method="POST" action="{{route('updatefrange', $frange->id)}}"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="usine">
                        <option value="{{$frange->usine}}" selected="selected">{{$frange->usine}}</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="frange">
                        <option value="{{$frange->frange}}" selected="selected">{{$frange->frange}}</option>
                        <option value="Produit Importé">Produit Importé</option>
                        <option value="Produit Fabriqué">Produit Fabriqué</option>
                    </select>
                </div>
                {{-- Referance --}}
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="references" name="references"
                        placeholder="Enter référance referance" value="{{$frange->references}}">
                </div>
                {{-- Color --}}
                <div class="form-group">
                    <label>Couleur</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Gold / Rouge / noir ..." name="color" value="{{$frange->color}}">
                    </div>
                </div>
                {{-- qty initial --}}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Add Quantity" name="inQty" value="{{$frange->inQty}}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Enter Qty" name="outQty" value="{{$frange->outQty}}">
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="JJ/MM/AAAA" name="date" value="{{$frange->date}}">
                    </div>
                </div>
                <div class="form-group">
                    <label>Image </label>
