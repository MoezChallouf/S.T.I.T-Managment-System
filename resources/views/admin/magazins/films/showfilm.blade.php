...
@section('title', 'Film Details - STIT Management')
        ...
        <div class="row  >
            <div class="col-lg-4 col-md-5 xs-margin-30px-bottom">
                <div class="team-single-img">
                    <img src="{{asset('dist/img/plastic.jpg')}}" alt="logo" style="width: 480px; height:350px; padding-right:50px;" >
                </div>
            </div>
        
            <div class="col-lg-8 col-md-7 ">
                <div class="team-single-text padding-50px-left sm-no-padding-left ">
                    <h1 class="font-size38 sm-font-size32 xs-font-size30" style="margin-bottom:30px;">Nom: {{$film->nom}}</h1>
                        ...
                        <ul class="list-style9 ">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-5 col-5">
                                        ...
                                        <strong class="margin-10px-left xs-margin-four-left text-pink">Reste en Stock:</strong>
                                    </div>
                                    <div class="col-md-7 col-7">
                                        <p>{{$film->total}}</p>
                                    </div>
                            ...
                            <li>
                                <div class="row ul">
                                    ...
                                    <div class="col-md-7 col-7">
                                        <p style="color: {{ $film->status === 'Epuisé' ? 'red' : 'green' }};" class="font-weight-bold ">{{$film->status}} </p>
                                    </div>
                                </div>
                            </li>
                        </ul>
