...
@section('title', 'Add Ticket - STIT Management')
...
<div class="col-6" style="margin: auto; padding: 40px;">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title text-white font-weight-bold">Add New Ticket</h3>
        </div>
        <form method="POST" action="{{ route('storeticket') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Quantité Ticket Consommée</label>
