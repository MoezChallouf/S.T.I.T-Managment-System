...
@section('title', 'Add Rebobine - STIT Management')
...
<div class="col-6" style="margin: auto; padding: 40px;">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title text-white font-weight-bold">Add New Rebobine</h3>
        </div>
        <form method="POST" action="{{ route('storerebobine') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
