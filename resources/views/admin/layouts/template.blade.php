...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand " style="background-color: #343a40">
    ...
    <ul class="navbar-nav" style="margin-left: auto;">
      <li class="nav-link text-white"><i class="fas fa-user-shield text-white" style="margin-right:5px;"></i> Admin</li>
  ...
  <footer class="main-footer ">
    <strong>Copyright &copy; 2023-2024 <a href="https://stit.com.tn">AdminSTIT</a>.</strong>
    All rights reserved.
